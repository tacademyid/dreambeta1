...
const PromptOutput = ({ prompts }) => {
  ...
  const exportToTxt = (prompts) => {
    let txtContent = "🎬 DreamWorksEdition - Modular Prompt\n\n";
  ...
  return (
    <div className="mt-8 space-y-6">
      <h2 className="text-xl font-semibold text-orange-700">📦 Hasil Modular Prompt</h2>
      ...
      <div className="flex flex-wrap gap-2 mb-4">
        ...
        <button
          ...
          className="ml-auto bg-green-600 hover:bg-green-700 text-white px-4 py-1 rounded text-sm"
        >
          💾 Ekspor .txt
        </button>
      </div>
      ...
      {sections.map((section, index) => {
        ...
        return (
          <motion.div
            ...
            className="border border-gray-300 dark:border-gray-700 rounded-md p-4 shadow-sm bg-gray-50 dark:bg-[#212c42] transition"

          >
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-2 gap-2">
  <h3 className="font-bold text-gray-800 dark:text-yellow-200 text-lg">{titles[section]}</h3>
